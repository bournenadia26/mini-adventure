# mini-adventure
A text-based fantasy RPG built in JavaFX. You've been hired by the king to retrieve something stolen by a dragon. Classic story, with the simple twist that the king is secretly evil and the dragon isn't.

Even though the story's skeleton is entirely scripted out, I only ever got a few pages into the final script. If you'd like to read what's there, please open `MiniAdventure.java` and scroll down to line 1087. World-building was not the priority here, but I hope my love for creative writing and humor comes across in the limited bit that's actually there.
